...
<div class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h1 class="m-0 text-dark">HamroPasal Dashboard</h1>
        </div><!-- /.col -->
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            <li class="breadcrumb-item"><a href="{{route('admin')}}">Home</a></li>
            <li class="breadcrumb-item active">HamroPasal Dashboard</li>
          </ol>
        </div><!-- /.col -->
      </div><!-- /.row -->
    </div><!-- /.container-fluid -->
          ...
          <div class="card">
            ...
            <div class="card-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <td> 
                <a href="{{route('merchants.edit',$merchant->id)}}"><button class="btn btn-secondary btn-sm">Edit</button></a>
                 <a href="{{route('merchants.show',$merchant->id)}}"><button class="btn btn-warning btn-sm">Show</button></a>
                {!! Form::open(['method' => 'DELETE','route' => ['merchants.destroy', $merchant->id],'style'=>'display:inline']) !!}
